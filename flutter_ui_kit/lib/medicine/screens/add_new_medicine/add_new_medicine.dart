...
class _AddNewMedicineState extends State<AddNewMedicine> {
  ...
  Future savePill() async {
    ...
    if (setDate.millisecondsSinceEpoch <=
      ...
      snackbar.showSnack(
          "Check your medicine time and date", _scaffoldKey, null, context);
    } else {
      //create pill object
      Pill pill = Pill(
      ...
      for (int i = 0; i < howManyWeeks; i++) {
        ...
        if (result == null) {
          snackbar.showSnack("Something went wrong", _scaffoldKey, null, context);
          return;
        } else {
      ...
      //---------------------------------------------------------------------------------------
      snackbar.showSnack("Saved", _scaffoldKey, null, context);
      Navigator.pop(context);
    }
  }
