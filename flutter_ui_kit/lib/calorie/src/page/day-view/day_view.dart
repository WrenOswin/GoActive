...
import 'package:fitness_ui_kit/calorie/src/model/food_track_task.dart';
import 'calorie-stats.dart';
import 'package:provider/provider.dart';
import 'package:fitness_ui_kit/calorie/src/services/database.dart';
import 'dart:math';
import 'package:fitness_ui_kit/calorie/src/utils/theme_colors.dart';
import 'package:fitness_ui_kit/calorie/src/utils/constants.dart';
        ...
        children: <Widget>[
          Container(
            ...
            child: LinearProgressIndicator(
              ...
              backgroundColor: const Color(0xffEDEDED),
              valueColor: const AlwaysStoppedAnimation<Color>(Color(FAT_COLOR)),
            ),
          ),
